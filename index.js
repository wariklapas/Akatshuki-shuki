...
client.on('message', message => {
  ...
  Akatshuki.set(message);
  Akatshuki.addPrefix('/');

  Akatshuki.createCommand('brainly ',function(msg,res){
  ...
  Virdina.createCommand("img ",function(msg,res){
    ...
    Akatshuki.replyMessage('*Downloading img....*')
    let getExtention = /[^.]+$/.exec(res.trim());
    Akatshuki.downloadImage(res.trim(),`image/img1.${getExtention}`,()=>{
  ...
  Akatshuki.createCommand('help',function(msg,res){
    pesan=``
    pesan+=`*Bot Akatshuki-Brainly 🤖 👩‍💻*\n*Menu*\n\n💡Brainly Search\n/brainly <pertanyaan> -<jumlah>\n*/brainly rumus mtk -10*`
